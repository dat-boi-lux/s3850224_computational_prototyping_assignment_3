var cube_scale = 22; //determines the general relative size of cubes (as well as other 3D objects in the scene)
var score = 0; //the accumulative score from collectibles
var timer = 100; //start timer at 100 (this is the invincibility time after an enemy collision)
var player_state = 1;
...
let enemy_array = []; //an array to store enemy objects
let player_array = []; //an array to store player objects
